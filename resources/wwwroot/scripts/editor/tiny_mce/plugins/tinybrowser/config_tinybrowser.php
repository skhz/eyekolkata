...
$tinybrowser['docroot'] = rtrim(str_replace('admin/js/editor/tiny_mce/plugins/tinybrowser','',realpath("./")),'');
//$tinybrowser['docroot'] ='/smhhome/f-web/fc/44/cwimports.com.au/public/www/newsite/';
// Folder permissions for Unix servers only
$tinybrowser['unixpermissions'] = 0777;

// File HTTP Path
$tinybrowser['path']['http_path'] = 'http://localhost/cwimports/';

// File upload paths (set to absolute by default)
$tinybrowser['path']['image'] = 'images/tinyImage/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = 'images/tinyImage/'; // Media files location
$tinybrowser['path']['file']  = 'images/tinyImage/'; // Other files location
...
$tinybrowser['link']['image'] = $tinybrowser['path']['http_path'].$tinybrowser['path']['image']; // Image links
$tinybrowser['link']['media'] = $tinybrowser['path']['http_path'].$tinybrowser['path']['media']; // Media links
$tinybrowser['link']['file']  = $tinybrowser['path']['http_path'].$tinybrowser['path']['file']; // Other file links
